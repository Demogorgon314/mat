...
public final class CliCommandCatalog
{
    ...
    private static Map<CliCommand, CommandDefinition> definitions()
    {
        ...
        definitions.put(CliCommand.INSPECT_OBJECT, new CommandDefinition(CliCommand.INSPECT_OBJECT,
                        "Inspect one object like MAT's object inspector, or jump directly to one or more field paths for targeted state checks.",
                        "mat-cli inspect-object <heap> --object 0x... [--select-fields FIELD | --field-paths PATH] [--show-nulls] [--limit N] [--depth N] [--format text|json]",
                        true, Collections.singletonList("heap"), Arrays.asList(option("--object", "0x...", true,
                                        "Object address to inspect."),
                                        option("--select-fields", "FIELD", false,
                                                        "Inspect one or more direct fields from the root object. May be repeated. Cannot be combined with --field-paths."),
                                        option("--field-paths", "PATH", false,
                                                        "Inspect one or more dotted field paths such as cleaner.offsetMap. May be repeated. Cannot be combined with --select-fields."),
